...
public class CountTheNumberOfDuplicated_Bug {
    ...
    public static String duplicatedLetters(String str){ // aabBcde
        ...
        String result = ""; // in order to get the element and its repeats

        for (char eachElement : eachCh) { //a
            ...
            if (Character.isLetter(eachElement) ) {
                ...
                for (char eachInArr : eachCh) { // a a b b c d e
