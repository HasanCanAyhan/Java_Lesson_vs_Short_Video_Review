...
import java_lab.lab14_ecommerceApplicationTasks.category.Electronic;
import java_lab.lab14_ecommerceApplicationTasks.category.Furniture;
import java_lab.lab14_ecommerceApplicationTasks.category.SkinCare;
import java_lab.lab14_ecommerceApplicationTasks.discount.AmountBasedDiscount;
import java_lab.lab14_ecommerceApplicationTasks.discount.Discount;
import java_lab.lab14_ecommerceApplicationTasks.discount.RateBasedDiscount;
...
public class DataGenerator {
    ...
    public static void createBalance(){
        ...
        Balance customerBalance = new CustomerBalance(StaticConstants.CUSTOMER_LIST.get(0).getId(),450.00); // ozzy
        //                                                    CustomerId
        Balance giftCardBalance = new GiftCardBalance(StaticConstants.CUSTOMER_LIST.get(1).getId(),500.00); // mike
